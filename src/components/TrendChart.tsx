...
export function TrendChart({ agentId, from, to, refreshKey }: TrendChartProps) {
  ...
  useEffect(() => {
    let active = true;
    api
      .getDaily(agentId, from, to, granularity)
      .then((data) => {
  ...
  }, [agentId, from, to, granularity, refreshKey]);
